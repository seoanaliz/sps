...
//   echo extension_loaded('tidy') ? "LOADED" : "NOT LOADED"; // outputs LOADED 
    class vk_parser
    {   
...
//
//        $f = new vk_parser();
//        $a = $f->get_info('http://vk.com/public22877876');
//             
//        $f->set_page($a['id'], $a['short_name']);
//
//        for ($i = 0; $i < 15; $i++){
//             $a = unserialize($f->get_posts($i));
//             if ($a && vk_parser::TESTING){
//                foreach ($a as $nvnvn)
//                {
//                    print_r($nvnvn);
//                    echo '<br><br>';
