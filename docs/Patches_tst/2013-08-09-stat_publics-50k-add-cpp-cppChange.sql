alter table "stat_publics_50k" add column "cpp" integer;
alter table "stat_publics_50k" add column "cppChange" text;
...
CREATE OR REPLACE VIEW get_publics AS
 SELECT stat_publics_50k.vk_id,
        ...
        stat_publics_50k."cpp",
        stat_publics_50k."cppChange"
