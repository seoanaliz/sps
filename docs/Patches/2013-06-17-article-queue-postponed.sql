ALTER TABLE "articleQueues" ADD COLUMN "postponed" boolean;
ALTER TABLE "articleQueues" ALTER COLUMN "postponed" SET DEFAULT false;
...
SELECT "public"."articleQueues"."articleQueueId"
    ...
    , "public"."articleQueues"."postponed"
