<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.iOSsetting.addTitle");
	
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://iOSsettings/" ) , 'title' => LocaleLoader::Translate( "vt.screens.iOSsetting.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://iOSsettings/add" ) , 'title' => LocaleLoader::Translate( "vt.common.crumbAdd" ) ) 
	);
?>
