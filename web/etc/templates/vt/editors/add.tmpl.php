<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.editor.addTitle");
	
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://editors/" ) , 'title' => LocaleLoader::Translate( "vt.screens.editor.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://editors/add" ) , 'title' => LocaleLoader::Translate( "vt.common.crumbAdd" ) ) 
	);
?>
