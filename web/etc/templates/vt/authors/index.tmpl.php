<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.author.list");

    $grid = array(
        "columns" => array(
           LocaleLoader::Translate( "vt.author.vkId" )
        ...
        , "operations"	=> true
        , "allowAdd"	=> true
        , "canPages"	=> AuthorFactory::CanPages()
        , "basepath"	=> Site::GetWebPath( "vt://authors/" )
        , "addpath"		=> Site::GetWebPath( "vt://authors/add" )
        , "title"		=> $__pageTitle
		, "description"	=> ''
