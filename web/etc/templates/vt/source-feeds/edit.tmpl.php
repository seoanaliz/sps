<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.sourceFeed.editTitle");
	...
	$__breadcrumbs = array( 
		...
		, array( 'link' => Site::GetWebPath( "vt://source-feeds/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
