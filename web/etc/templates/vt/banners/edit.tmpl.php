<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.banner.editTitle");
	...
	$__breadcrumbs = array( 
		...
		, array( 'link' => Site::GetWebPath( "vt://banners/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
