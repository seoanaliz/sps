...
$__pageTitle = LocaleLoader::Translate( "vt.screens.stat.addTitle");

$__breadcrumbs = array(
    array( 'link' => Site::GetWebPath( "vt://stat-groups/" ) , 'title' => LocaleLoader::Translate( "vt.screens.group.list" ) )
, array( 'link' => Site::GetWebPath( "vt://stat-groups/add" ) , 'title' => LocaleLoader::Translate( "vt.common.crumbAdd" ) )
);
?>
