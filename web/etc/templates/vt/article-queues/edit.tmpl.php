<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.articleQueue.editTitle");
	...
	$__breadcrumbs = array( 
		...
		, array( 'link' => Site::GetWebPath( "vt://article-queues/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
