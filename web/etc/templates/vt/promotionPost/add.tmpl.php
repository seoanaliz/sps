<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.promotionPost.addTitle");
	
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://promotionPost/" ) , 'title' => LocaleLoader::Translate( "vt.screens.promotionPost.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://promotionPost/add" ) , 'title' => LocaleLoader::Translate( "vt.common.crumbAdd" ) ) 
	);
?>
