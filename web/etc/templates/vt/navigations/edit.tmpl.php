<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.navigation.editTitle");
	...
	$__breadcrumbs = array( 
		...
		, array( 'link' => Site::GetWebPath( "vt://navigations/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
