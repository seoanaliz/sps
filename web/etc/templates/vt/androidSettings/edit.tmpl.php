<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.androidSetting.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://androidSettings/" ) , 'title' => LocaleLoader::Translate( "vt.screens.androidSetting.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://androidSettings/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			{increal:tmpl://vt/androidSettings/data.tmpl.php}
			
			<div class="buttons">
				<a href="{web:vt://androidSettings/}" class="back">&larr; {lang:vt.common.back}</a>
