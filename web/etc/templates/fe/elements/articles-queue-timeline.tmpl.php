    ...
    <?
        if (!empty($grid)) {
            ...
            foreach ($grid as $gridItem) {
                $gridDate = !empty($gridItem['emptyDateTime']) ? $gridItem['emptyDateTime'] : $gridItem['dateTime'];
                if (empty($lastGridDate) || $lastGridDate->format('d.m.Y') != $gridDate->format('d.m.Y')) {
                    $lastGridDate = clone($gridDate);
                    ?>
                        <div class="queue-title">
                            <?= DateTimeHelper::GetRelativeDateString($gridDate, false) ?>
                ...
                //empty grid item
                if (!empty($gridItem['emptyDateTime'])) {
