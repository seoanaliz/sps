 ...
 *	
 *
 *  ВНИМАНИЕ! Эта версия была модифицирована Евгением Куликовым (kulikov)
 *  Коммит https://github.com/Topface/sps/commit/032d7f9ebb10360c0c8759e8d2dd35a0a165f1f1
 *  Во избежание багов позиционирования используйте только со стилем:
 *  .ui-sortable {
 *      position: relative;
 *  }
 *
 */(function(a, b) {
    a.widget("ui.sortable", a.ui.mouse, {widgetEventPrefix: "sort", ready: !1, options: {appendTo: "parent", axis: !1, connectWith: !1, containment: !1, cursor: "auto", cursorAt: !1, dropOnEmpty: !0, forcePlaceholderSize: !1, forceHelperSize: !1, grid: !1, handle: !1, helper: "original", items: "> *", opacity: !1, placeholder: !1, revert: !1, scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, scope: "default", tolerance: "intersect", zIndex: 1e3}, _create: function() {
            ...
            this.cssPosition == "absolute" && this.scrollParent[0] != document && !this.scrollParent.is($('html')) && a.ui.contains(this.scrollParent[0], this.offsetParent[0]) && (b.left += this.scrollParent.scrollLeft(), b.top += this.scrollParent.scrollTop());
