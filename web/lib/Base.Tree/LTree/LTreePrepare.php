<?php
    ...
    class LTreePrepare {
         ...
         * @return string
         */
        public static function PrepareGetCommand( $searchArray = array(), $options, $object = null, $mapping, $conn ) {
         ...
         * @return string
         */
        public static function PrepareCountCommand( $searchArray = array(), $options, $object = null, $mapping, $conn ) {
            $searchArray = BaseFactory::ValidateSearch( $searchArray, $mapping, $options, $conn->GetName() );
         ...
         * @return string
         */
        public static function PrepareGetByIdCommand( $searchArray = array(), $options, $mapping, $conn ) {
            $searchArray = BaseFactory::ValidateSearch( $searchArray, $mapping, $options, $conn->GetName() );
            $query       = 'SELECT * FROM  ' . $conn->quote( $mapping["view"] );
            $query      .= BaseFactoryPrepare::PrepareGetOrCountFields( $searchArray, $mapping, $options, $conn );
