<?php
    ...
    class SenderVkontakte
    {
        ...
        private $post_photo_array = array();    //массив адресов фоток
        ...
        public function __construct( $post_data )
        {
            ...
            $this->post_photo_array =   array('c:/1.jpg');#$post_data['photo_array'];
            ...
            $this->audio_id         =   $post_data['audio_id'] ? $post_data['audio_id'] : array();//массив вида array('videoXXXX_YYYYYYY','...')
            $this->video_id         =   $post_data['video_id'] ? $post_data['video_id'] : array();//массив вида array('audioXXXX_YYYYYYY','...')
    ...
    //                    $text2";
        ...
        private function edit_post( $attaches, $post_id )
        {
            ...
            $res = VkHelper::api_request( 'edit.post', $params, false );
    //            print_r($res);
