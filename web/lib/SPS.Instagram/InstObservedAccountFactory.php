<?php
    ...
    /**
     * InstObservedAccount Factory
     *
     * @package SPS
     * @subpackage Instagram
     */
    class InstObservedAccountFactory implements IFactory {

        /** Default Connection Name */
        const DefaultConnection = 'tst';

        /** InstObservedAccount instance mapping  */
        public static $mapping = array (
            'class'       => 'InstObservedAccount'
            , 'table'     => 'inst_observed_accounts'
            , 'view'      => 'getInst_observed_accounts'
